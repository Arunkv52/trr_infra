...
const Contact = () => {
  return (
    <>
      <div className="md:flex md:items-start pb-10" id="Contact">
        <div className="contact-text md:py-20 py-10 md:px-10 px-5 md:w-1/2 w-full">
          ...
          <p className="md:py-4 py-0">
            <strong>TRR Infra:</strong> The Global Leader in SLCM with Over 25,000 Deliveries
            Worldwide. Trust Our Expertise to Elevate Your Projects.
          </p>
        </div>
        <div className="contact-text md:py-20 py-0 md:pb-0 pb-10 md:px-40 px-0 w-full">
          <div className="full-contain md:pb-10 pb-0">
            <div className="form-contact md:px-5 px-5 w-full">
              <form action="" method="get" className="flex flex-col gap-3">
                ...
                <button
                  type="submit"
                  className="bg-[#ff0000] hover:bg-blue-900 text-white font-bold md:py-3 py-3 cursor-pointer"
                >
                  Submit
                </button>
              </form>
